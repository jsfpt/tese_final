...
function servicesSim(svg2,iterativeZoom) {
    console.log("------- Group by Service simulation------");
    ...
    servicesGraph(servicesWithInfo,edgeArrayWithHttpInfo,svg,servicesTarjan,totalNumberRequests,totalAverageTime,iterativeZoom);


}

function servicesGraph(list_services,list_edges,svg,servicesTarjan,totalNumberRequests,totalAverageTime,iterativeZoom){  // return component arrays and their links
    ...
    neighborsArray = pathFromNodeServices(serviceArrayGraph,EdgeArrayGraph,neighborsArray);  //init neighborsArray
    ...
    arraySetOfServices = groupByService2(serviceArrayGraph,EdgeArrayGraph,neighborsArray,arraySetOfServices,arrayEdgesSets,nodesComponets,linkComponets); //arraySetOfServices
    ...
    //return;
    addLeftElementsToSccServices(arraySetOfServices);

    //console.log(arraySetOfServices);
    //console.log(neighborsArray);
    arrayEdgesSets = new Array();

    arrayEdgesSets = edgesFromSetOfServices2(arraySetOfServices,neighborsArray,arrayEdgesSets);  //   return arrayEdgesSets
    ...
    svg2 = setXYPositionD3_2(1,"normal",nodesComponetsJson,linksComponetsJson,svgGlobal,viewBoxFixSize,viewBoxFixSizeHeight,raius,forceCollide,100,0,0,"#0080ff",0,nodesComponets,iterativeZoom,linkComponets);             // without Tarjan


}


function  groupByService2(serviceArrayGraph,EdgeArrayTarjanGraph,neighborsArray,arraySetOfServices,arrayEdgesSets,nodesComponets,linkComponets)      // return arraySetOfServices
{
...
function addLeftElementsToSccServices(arraySetOfServices)
{
    //console.log(arraySetOfServices);
    //console.log(neighborsArray);
...
function edgesFromSetOfServices2(arraySetOfServices,neighborsArray,arrayEdgesSets2)
{
...
function pathFromNodeServices(serviceArray,EdgeArray,neighborsArray)  //Return neighborsArray
{
